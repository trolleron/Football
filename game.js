...
function preload() {
    const assets = [
        ...
        ['cap_top', 'Top-Down Simple Summer_Ground 37.png'], 
        ['cap_bottom', 'Top-Down Simple Summer_Ground 39.png']
    ];
...
function create() {
    ...
    for (let y = 0; y < ROWS; y++) {
        for (let x = 0; x < COLS; x++) {
            ...
            // --- 1. ПРАВАЯ ШТРАФНАЯ (5x7) ---
            if (x >= 20 && x <= 24 && y >= 4 && y <= 10) {
                ...
                else if (x === 22 && y === 7) tileKey = 'center_dot';
                else if (x === 24) tileKey = 'b_right'; // Линия за воротами внутри штрафной
            }

            // --- 2. ЛЕВАЯ ШТРАФНАЯ (5x7) ---
                ...
                else if (x === 2 && y === 7) tileKey = 'center_dot';
                else if (x === 0) tileKey = 'b_left'; // Линия за воротами внутри штрафной
            }

            // --- 3. ЦЕНТРАЛЬНЫЙ КРУГ И ЛИНИЯ ---
            else if (x === 12 && y === 5) tileKey = 'cap_bottom'; // Ограничитель сверху
            else if (x === 12 && y === 9) tileKey = 'cap_top';    // Ограничитель снизу
            ...
            // --- 4. ОБЩИЕ ГРАНИЦЫ ПОЛЯ (Если тайл еще не занят штрафной) ---
            if (tileKey === 'grass') {
